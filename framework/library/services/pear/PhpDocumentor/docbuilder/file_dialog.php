...
if ('/Users/tqwhite/Documents/webdev/tqWhiteFiles/tq.org/tqwhite.org/framework/library/services/pear' != '@'.'WEB-DIR@')
{
    /**
    ...
    */
    ...
    require_once( '/Users/tqwhite/Documents/webdev/tqWhiteFiles/tq.org/tqwhite.org/framework/library/services/pear' . PATH_DELIMITER . 'PhpDocumentor/docbuilder/includes/utilities.php' );
    ...
    $ini = phpDocumentor_parse_ini_file('/Users/tqwhite/Documents/webdev/tqWhiteFiles/tq.org/tqwhite.org/framework/library/services/pear' . PATH_DELIMITER . 'PhpDocumentor/phpDocumentor.ini', true);
    if (isset($ini['_phpDocumentor_options']['userdir'])) {
        $configdir = $ini['_phpDocumentor_options']['userdir'];
    } else {
        $configdir = '/Users/tqwhite/Documents/webdev/tqWhiteFiles/tq.org/tqwhite.org/framework/library/services/pear' . PATH_DELIMITER . 'PhpDocumentor/user';
    }
} else {
