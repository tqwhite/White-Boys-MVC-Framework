...
if ('/Users/tqwhite/Documents/webdev/tqWhiteFiles/tq.org/tqwhite.org/framework/library/services/pear' != '@'.'DATA-DIR@')
{
    $root_dir = 'PhpDocumentor';
    $path = '/Users/tqwhite/Documents/webdev/tqWhiteFiles/tq.org/tqwhite.org/framework/library/services/pear/PhpDocumentor/docbuilder/images/';

    /**
    * common file information
    */
    include_once("PhpDocumentor/phpDocumentor/common.inc.php");
    include_once("/Users/tqwhite/Documents/webdev/tqWhiteFiles/tq.org/tqwhite.org/framework/library/services/pear/PhpDocumentor/docbuilder/includes/utilities.php" );

    // find the .ini directory by parsing phpDocumentor.ini and extracting _phpDocumentor_options[userdir]
    $ini = phpDocumentor_parse_ini_file('/Users/tqwhite/Documents/webdev/tqWhiteFiles/tq.org/tqwhite.org/framework/library/services/pear/PhpDocumentor/phpDocumentor.ini', true);
    if (isset($ini['_phpDocumentor_options']['userdir'])) {
    	$configdir = $ini['_phpDocumentor_options']['userdir'];
    } else {
    	$configdir =  '/Users/tqwhite/Documents/webdev/tqWhiteFiles/tq.org/tqwhite.org/framework/library/services/pear/PhpDocumentor/user';
    }
} else {
