...
$this->addJsInclude("../framework/mvc/views/site_utilities/jsIncludes/test.js"); //relative to public_html/index/php
$this->addCssInclude("../framework/mvc/views/site_utilities/cssIncludes/test.css"); //relative to public_html/index/php
...
<div class='linkedClass'>this is also manual but the css is linked (and it's a fancy font!!)(ps, Hi Wade!)</div>
</div>
<?php
