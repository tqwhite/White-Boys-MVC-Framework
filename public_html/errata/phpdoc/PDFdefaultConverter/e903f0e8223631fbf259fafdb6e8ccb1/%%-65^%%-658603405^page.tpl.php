...
<?php ob_start();  echo $this->_tpl_vars['name'];  $this->_smarty_vars['capture']['pagelink'] = ob_get_contents(); ob_end_clean();  ob_start();  echo $this->_tpl_vars['name']; ?>
|||<?php echo $this->_tpl_vars['sdesc'];  $this->_smarty_vars['capture']['pageindex'] = ob_get_contents(); ob_end_clean();  ob_start(); ?>Package <?php echo $this->_tpl_vars['package']; ?>
