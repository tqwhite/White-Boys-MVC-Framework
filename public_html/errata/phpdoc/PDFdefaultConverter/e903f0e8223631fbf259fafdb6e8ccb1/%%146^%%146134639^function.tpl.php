...
<?php ob_start(); ?>Function <?php echo $this->_tpl_vars['intricatefunctioncall']['name'];  $this->_smarty_vars['capture']['flink'] = ob_get_contents(); ob_end_clean();  ob_start();  echo $this->_tpl_vars['intricatefunctioncall']['name']; ?>
