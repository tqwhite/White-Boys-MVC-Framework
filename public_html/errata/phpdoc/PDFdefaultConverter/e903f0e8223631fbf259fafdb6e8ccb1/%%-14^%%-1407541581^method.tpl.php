...
<?php ob_start();  if ($this->_tpl_vars['constructor']): ?>Constructor <?php else: ?>Method <?php endif;  echo $this->_tpl_vars['intricatefunctioncall']['name'];  $this->_smarty_vars['capture']['mlink'] = ob_get_contents(); ob_end_clean();  ob_start();  if ($this->_tpl_vars['constructor']): ?>constructor <?php endif;  echo $this->_tpl_vars['class']; ?>
