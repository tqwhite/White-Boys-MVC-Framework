...
<?php ob_start();  if ($this->_tpl_vars['is_interface']): ?>Interface<?php else: ?>Class<?php endif; ?> <?php echo $this->_tpl_vars['name'];  $this->_smarty_vars['capture']['clink'] = ob_get_contents(); ob_end_clean();  ob_start();  echo $this->_tpl_vars['name']; ?>
|||<?php echo $this->_tpl_vars['sdesc'];  $this->_smarty_vars['capture']['cindex'] = ob_get_contents(); ob_end_clean();  ob_start(); ?>Package <?php echo $this->_tpl_vars['package']; ?>
 Classes<?php $this->_smarty_vars['capture']['classeslink'] = ob_get_contents(); ob_end_clean();  if ($this->_tpl_vars['plink']):  ob_start(); ?>Package <?php echo $this->_tpl_vars['package'];  $this->_smarty_vars['capture']['plink'] = ob_get_contents(); ob_end_clean();  endif;  if ($this->_tpl_vars['includeheader']):  $_smarty_tpl_vars = $this->_tpl_vars;
